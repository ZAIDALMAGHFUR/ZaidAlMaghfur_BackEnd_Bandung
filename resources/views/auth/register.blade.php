...
<html lang="en">
  <head>
    ...
    <title>MOBIL - Media Informatika</title>
    <!-- Google font-->
              ...
              <form class="theme-form login-form needs-validation" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="phone_number" type="number" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}"  autocomplete="phone_number" autofocus placeholder=" Number Phone">
                  ...
                  <div class="form-group">
                    ...
                    <div class="small-group">
                      <div class="input-group">
                        <input id="address" type="address" class="form-control @error('address') is-invalid @enderror" name="address" autocomplete="address" placeholder="Address">
                        @error('address')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="input-group">
                    <input id="no_sim" type="number" class="form-control @error('no_sim') is-invalid @enderror" name="no_sim" autocomplete="no_sim" placeholder="No Sim">
