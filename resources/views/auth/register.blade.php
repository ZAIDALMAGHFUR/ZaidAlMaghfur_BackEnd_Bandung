...
<body>
    ...
    <section>
        <div class="container-fluid p-0">
            <div class="row m-0">
                <div class="col-xl-7 order-1"><img class="bg-img-cover bg-center" src="../assets/images/login/1.jpg"
                        alt="looginpage"></div>
                        ...
                        <form class="theme-form login-form needs-validation" method="POST"
                                ...
                                <div class="small-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="phone_number" type="number"
                                            ...
                                            autocomplete="phone_number" autofocus placeholder=" Number Phone">
                            ...
                            <div class="form-group">
                                ...
                                <div class="small-group">
                                    ...
                                    <div class="input-group">
                                        <input id="no_sim" type="number"
                                            class="form-control @error('no_sim') is-invalid @enderror" name="no_sim"
                                            autocomplete="no_sim" placeholder="No Sim">
