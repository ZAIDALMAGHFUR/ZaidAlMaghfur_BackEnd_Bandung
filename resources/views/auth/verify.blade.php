                    ...
                    <div class="login-main">
                        <div class="theme-form login-form">
                            ...
                            @if (session('resent'))
                                ...
                                ?>
                            @endif
                            <img class="col-12 rounded-circle" src="{{ asset('assets/images/email-sent.gif') }}"
                                alt="email-sent" />
                            <h6 class="f-w-400 mb-3">We have sent the verification mail to <span
                                    class="txt-primary">{{ Auth::user()->email }}</span>. If
                                you cannot find the <i><u>email verification</u></i> mail in the Index folder, please
                                check the
                                Junk/Spam folder.</h6>
                            <h6 class="f-w-400">If you did not receive the <i><u>email verification</u></i> mail please
                                click on the
                                resend button.</h6>
