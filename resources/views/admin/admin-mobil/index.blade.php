      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <a href="{{ route('admin/mobile.create') }}" class="btn btn-primary">Add Mobile</a>
          </div>
                ...
                <tbody>
                  @foreach ($mobiles as $item)
                    <tr style="text-align: center">
                      ...
                      <td>
                        <img src="{{ url('img') . '/' . $item->gambar_mobils }}" alt="" width="100px">
                      </td>
                      <td>
                      ...
                      <td>
                        <form method="POST" action="{{ route('admin/mobile.destroy', $item->id) }}">
                          @csrf
                          <a href="{{ route('admin/mobile.edit', [$item]) }}" type="button" class="btn btn-primary btn-xs edit" data-bs-id=""><i
