        ...
        <div class="page-body-wrapper sidebar-icon">
            ...
            <header class="main-nav">
                <div class="sidebar-user text-center"><a class="setting-primary" href="{{ route('profile') }}"><i
                        ...
                        src="{{ Storage::url(Auth::user()->foto) == '/storage/' ? asset('assets/images/dashboard/1.png') : Storage::url(Auth::user()->foto) }}"
                        alt="">
                    ...
                    <div class="main-navbar">
                        ...
                        <div id="mainnav">
                            <ul class="nav-menu custom-scrollbar">
                                ...
                                <li class="dropdown"><a class="nav-link menu" href="{{ route('user') }}"><i
                                ...
                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i
                                    ...
                                    <ul class="nav-submenu menu-content">
                                        <li><a href="{{ route('user/req') }}">Daftar Menjadi Agent</a></li>
                                        {{-- <li><a href="{{ route('cek') }}">Cek Status Agent</a></li> --}}
                                    </ul>
                                </li>
                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i
                                            data-feather="book"></i><span>Data Sewa </span></a>
                                    <ul class="nav-submenu menu-content">
                                        <li><a href="{{ route('user/sewa') }}">Sewa Mobil</a></li>
                                        <li><a href="{{ route('user/retrunt') }}">Pengembalian Mobil</a></li>
                                    </ul>
                                <li class="dropdown"><a class="nav-link menu" href="{{ route('user/profile') }}"><i
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 footer-copyright">
                            <p class="mb-0">MOBIL - Media Informatika.</p>
                        </div>
                        <div class="col-md-6">
