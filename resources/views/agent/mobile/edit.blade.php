                            ...
                            <div class="col-lg-12">
                                <div class="card p-3">
                                    <form method="post" class="needs-validation" novalidate=""
                                        action="{{ route('mobile.update', [$mobile]) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('POST')
                                        @if ($errors->any())
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="nama_mobil"
                                                        value="{{ old('nama_mobil', $mobile->nama_mobil) }}" id="nama_mobil"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="merk_mobil"
                                                        value="{{ old('merk_mobil', $mobile->merk_mobil) }}" id="merk_mobil"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="plat_nomor"
                                                        value="{{ old('plat_nomor', $mobile->plat_nomor) }}"
                                                        id="plat_nomor" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="warna_mobil"
                                                        value="{{ old('warna_mobil', $mobile->warna_mobil) }}"
                                                        id="warna_mobil" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" class="form-control" name="tahun_keluaran"
                                                        value="{{ old('tahun_keluaran', $mobile->tahun_keluaran) }}"
                                                        id="tahun_keluaran" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" class="form-control" name="harga_sewa"
                                                        value="{{ old('harga_sewa', $mobile->harga_sewa) }}"
                                                        id="harga_sewa" required>
                                                </div>
                                            </div>
                                        </div>
