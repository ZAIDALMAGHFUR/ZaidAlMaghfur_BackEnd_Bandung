                            ...
                            <div class="col-lg-12">
                                <div class="card p-3">
                                    <form method="post" class="needs-validation" novalidate=""
                                        action="{{ route('user/sewa/store') }}" enctype="multipart/form-data">
                                        @csrf
                                        @if ($errors->any())
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="js-example-basic-single col-sm-12" name="mobil_id"
                                                        id="mobil_id">
                                                        <option value="">-- Select Mobil --</option>
                                                        @foreach ($mobil as $item)
                                                            <option value="{{ $item->id }}">{{ $item->nama_mobil }} -
                                                                {{ $item->status_mobil }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="id_users"
                                                        value="{{ $auth }}" id="id_users" required disabled
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="date" class="form-control" name="tanggal_sewa"
                                                        value="{{ old('tanggal_sewa') }}" id="tanggal_sewa" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="date" class="form-control" name="tanggal_kembali"
                                                        value="{{ old('tanggal_kembali') }}" id="tanggal_kembali"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
