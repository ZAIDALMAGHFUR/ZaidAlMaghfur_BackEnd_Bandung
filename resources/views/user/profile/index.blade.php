                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" class="needs-validation" novalidate=""
                                    action="{{ route('user/profile/update', [$user]) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row align-items-start">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="first_name"
                                                value="{{ old('name_mata_kuliah', $user->first_name) }}" id="first_name"
                                    ...
                                    <div class="form-group row align-items-start">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="last_name"
                                                value="{{ old('name_mata_kuliah', $user->last_name) }}" id="last_name"
                                                placeholder="Masukkan Nama yang sekarang">
                                    ...
                                    <div class="form-group row align-items-start">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="email"
                                                value="{{ old('name_mata_kuliah', $user->email) }}" id="email"
                                                placeholder="Masukkan Nama yang sekarang">
                                    ...
                                    <div class="form-group row align-items-start">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="phone_number"
                                                value="{{ old('name_mata_kuliah', $user->phone_number) }}"
                                                id="phone_number" placeholder="Masukkan Nama yang sekarang">
                                    ...
                                    <div class="form-group row align-items-start">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="longText" class="form-control" name="address"
                                                value="{{ old('name_mata_kuliah', $user->address) }}" id="address"
                                                placeholder="Masukkan Nama yang sekarang">
                                    ...
                                    <div class="form-group row align-items-start">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="no_sim"
                                                value="{{ old('name_mata_kuliah', $user->no_sim) }}" id="no_sim"
                                                placeholder="Masukkan Nama yang sekarang">
